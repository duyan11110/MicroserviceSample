...
public class SampleDbMigrationService : ITransientDependency
{
    ...
    private readonly ILogger<SampleDbMigrationService> _logger;
    private readonly ITenantRepository _tenantRepository;
    private readonly IUnitOfWorkManager _unitOfWorkManager;

    public SampleDbMigrationService(
        ILogger<SampleDbMigrationService> logger,
        ...
        CancellationToken cancellationToken)
    {
        using (var uow = _unitOfWorkManager.Begin(true))
        {
            ...
            await MigrateDatabaseAsync<Test1ServiceDbContext>(cancellationToken);
